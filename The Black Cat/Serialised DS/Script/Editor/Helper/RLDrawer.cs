...
namespace TheBlackCat.SerialisedDS.Editor
{
    public class RLDrawer
    {
        ...
        protected SerialisedDSHelper helper;
        ...
        public RLDrawer(SerializedProperty property, GUIContent label)
        {
            ...
            helper = SerialisedDSHelper.Instance;
        ...
        protected void OnDrawHeader(Rect rect)
        {
            ...
            helper.SetRLExpanded(listProperty, EditorGUI.Foldout(rect.ExpandLeft(7), helper.IsRLExpanded(listProperty), GUIContent.none, true));
